...
const getCorsHeaders = (requestOrigin: string | null) => {
  ...
  // Allow all Lovable.app subdomains and Supabase domains in production
  const isLovableApp = requestOrigin?.endsWith('.lovable.app') || requestOrigin?.endsWith('.lovable.dev');
